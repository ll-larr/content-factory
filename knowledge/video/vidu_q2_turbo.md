...
> (v3 JSON `start-end-to-video-q2-turbo` с полями `image`/`last_image`, либо
> v1-multipart-загрузка). id, цены и имена полей подтверждены живыми генерациями
> 2026-07-08 (WaveSpeed) и 2026-08-01 (Runware) — см. `status` во frontmatter.
