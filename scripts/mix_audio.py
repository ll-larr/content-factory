...
#   release=1150 — длинный: на 250-900 мс музыка возвращалась слишком быстро и
#     между короткими фразами слышно было «дыхание» громкости. При 1150 мс
#     подложка держится приглушённой всю реплику и поднимается после неё.
# Вариант без дакинга отвергнут: реплики тонут в музыке.
DUCK = "sidechaincompress=threshold=0.01:ratio=20:attack=5:release=1150"
