...
между отрезками СОЗНАТЕЛЬНО не делается (решение 2026-08-01, роадмап Фаза 3):
разрешение задаётся в project.json на весь проект, разнобой внутри эпизода —
ошибка конфигурации, и падение с внятной ошибкой честнее молчаливого апскейла.
Пересматривать, если появятся проекты со смешанными разрешениями отрезков.
